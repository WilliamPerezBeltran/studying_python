...
def encuesta():
	...
	contador_de_edades(l_eda_h,l_eda_m)
	anos_y_estudio_de_hombre_joven(l_eda_h,lista_carreras,carrera_h)
...
def contador_de_edades(l_eda_h,l_eda_m):
	#lista_carreras 
	contador_edad_h = 0
	for edad in l_eda_h:
		if edad < 18:
...
def anos_y_estudio_de_hombre_joven(l_eda_h,lista_carreras,carrera_h):
	pivote=True
	posicion_menor = 0
